export enum AppLink {
  ...
  DashboardHelpdesk = "/dashboard/helpdesk",
  DashboardHelpdeskArticle = "/dashboard/helpdesk/:publicId",
  ...
  AdminTableCreate = "/admin/tables/:tableName/create",
  ...
  AdminUserToggleManualMode = "/admin/users/:id/toggle-manual-mode",
  AdminConversations = "/admin/conversations",
  AdminConversationDetail = "/admin/conversations/:id",
  AdminConversationSendMessage = "/admin/conversations/:id/send-message",
